...
if (quant_method=="gene_counts") {
  ...
  utils::write.table(qnorm_assay_fc_formatted, paste0(output_dir, paste0(study_name, "." , quant_method, "_norm_exprs.tsv")), sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)
