...
- [Concordance between expression and genotype data](#concordance-between-expression-and-genotype-data)
...
Sex_QC_plot <- ggplot2::ggplot(sex_qc_df,
      ...
      ggplot2::labs(x="Expression of XIST", y="Expression of genes on chrY", title = paste0(study_name, " DS - TPM normalized, log2 | Sample Size: ", nrow(sex_qc_df))) +
      ggplot2::theme(plot.title = element_text(size = 12, face="italic")) +
      ggplot2::theme_bw()
...
Project genotyped individuals to the first two prinicipal components of the 1000 Genomes Phase 3 reference panel.
...
message("Number of genotyped individuals in current study ", study_name, ": ", projections_pcs %>% nrow())
message("Number of genotyped individuals in reference panel: ", main_pca %>% nrow())
...
Uses [QTLtools mbv](https://doi.org/10.1093/bioinformatics/btx074) (Match BAM to VCF) tool to check concordance between genotype data and genetic variants detected from the RNA-seq data. 
