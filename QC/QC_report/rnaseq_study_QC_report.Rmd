...
message("Number of genotyped individuals in the current study ", study_name, ": ", projections_pcs %>% nrow())
message("Number of genotyped individuals in the reference panel: ", main_pca %>% nrow())
