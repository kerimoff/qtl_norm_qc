...
rmarkdown::render( 
    ...
    output_file = "/gpfs/hpc/home/kerimov/SampleArcheology/QC_reports/CEDAR_QC_report.html",
    params = list(
...
# rmarkdown::render( 
#     input = "/gpfs/hpc/home/kerimov/qtl_norm_qc/QC/QC_report/array_study_QC_report.Rmd",
#     output_file = "/gpfs/hpc/home/kerimov/SampleArcheology/QC_reports/Fairfax_2012_QC_report.html",
#     params = list(
...
rmarkdown::render( 
    input = "/gpfs/hpc/home/kerimov/qtl_norm_qc/QC/QC_report/array_study_QC_report.Rmd",
    output_file = "/gpfs/hpc/home/kerimov/SampleArcheology/QC_reports/Fairfax_2014_QC_report.html",
    params = list(
...
rmarkdown::render( 
    input = "/gpfs/hpc/home/kerimov/qtl_norm_qc/QC/QC_report/array_study_QC_report.Rmd",
    output_file = "/gpfs/hpc/home/kerimov/SampleArcheology/QC_reports/Kasela_2017_QC_report.html",
    params = list(
...
rmarkdown::render( 
    input = "/gpfs/hpc/home/kerimov/qtl_norm_qc/QC/QC_report/array_study_QC_report.Rmd",
    output_file = "/gpfs/hpc/home/kerimov/SampleArcheology/QC_reports/Naranbhai_2015_QC_report.html",
    params = list(
